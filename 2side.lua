...
local Icons = {
    ["lucide-2side"] = "rbxassetid://105242031754218",
...
Home:AddButton({
    ...
    Callback = function()
        print("[2SIDE] Version:", Fluent.Version or "Unknown")
    end
})
...
local selectedMap = "Ancient Jungle"
...
REFishingStopped.OnClientEvent:Connect(function()
    ...
    local embedData = {
        ["embeds"] = {{
            ...
            ["footer"] = { ["text"] = "Fish It Webhook by 2SIDE" },
